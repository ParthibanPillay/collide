...
export default function SignUpForm() {
    ...
    const handleVerificationSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            setVerificationError(error.errors?.[0]?.message || "error occured during signUp")
        } finally {
            setIsSubmitting(false);
        }
    }
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <p>We've have sent an verification code to your email</p>
                </CardHeader>
